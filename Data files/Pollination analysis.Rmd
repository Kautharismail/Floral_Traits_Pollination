...
This scripture will use the various floral traits including flower colour and UV presence,corolla tube depth,nectar sugar content and number of flowers per plot for each cultivar:to determine attractiveness to **bumblebees** and **honeybees**
...
<details>
 ...
 #Looking at the summary of the data to ensure cultivar factor  
```{r}
summary(data_frame_new)
data_frame_new
```
